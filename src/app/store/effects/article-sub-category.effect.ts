...
export class ArticleSubCategoryEffect {
    ...
    loadArticleSubCategory = createEffect(() => this.actions$.pipe(
        ofType(ArticleSubCategoryActionTypes.GET_ARTICLE_SUB_CATEGORY),
        mergeMap(() => this.articleSubCategoryService.getAll().pipe(
    ...
    addArticleSubCategory = createEffect(() => this.actions$.pipe(
        ofType(ArticleSubCategoryActionTypes.ADD_ARTICLE_SUB_CATEGORY),
        // @ts-ignore
        mergeMap((data) => this.articleSubCategoryService.save(data.payload).pipe(
            map(articleSubCategories => ({
    ...
    deleteArticleSubCategory = createEffect(() => this.actions$.pipe(
        ofType(ArticleSubCategoryActionTypes.DELETE_ARTICLE_SUB_CATEGORY),
        // @ts-ignore
        mergeMap((data) => this.articleSubCategoryService.delete(data.payload).pipe(
            map(() => ({
